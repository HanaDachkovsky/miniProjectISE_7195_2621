...
public class VectorTests {
	...
	public void testAdd() {
		...
		// TC01:
		assertEquals(new Vector(4, 0, 4), new Vector(1, 2, 3).add(new Vector(3, -2, 1)));
	...
	public void testSubtruct() {
		// ============ Equivalence Partitions Tests ==============
		// TC01:
		assertEquals(new Vector(-2, 4, 2), new Vector(1, 2, 3).subtract(new Vector(3, -2, 1)));
		// =============== Boundary Values Tests ==================
	...
	public void testCrossProduct() {
		...
		assertEquals(new Vector(0, 0, 1), new Vector(1, 0, 0).crossProduct(new Vector(1, 1, 0)));
		...
		assertEquals(new Vector(0, 0, -20), new Vector(3, 4, 0).crossProduct(new Vector(5, 0, 0)));
	}
	...
	public void testDotProduct() {
		// ============ Equivalence Partitions Tests ==============
		// TC01:the angle between the vectors is between 0-90
		assertTrue(Util.isZero(1 - new Vector(1, 0, 0).dotProduct(new Vector(1, 1, 0))));
		// TC02:the angle between the vectors is between 90 -180
		assertTrue(Util.isZero(-1 - new Vector(1, 0, 0).dotProduct(new Vector(-1, 1, 0))));
		// =============== Boundary Values Tests ==================
		// TC03: multiply parallel vectors
		assertTrue(Util.isZero(28 - new Vector(1, 2, 3).dotProduct(new Vector(2, 4, 6))));
		// TC04: multiply by opposite vector
		assertTrue(Util.isZero(-14 - new Vector(1, 2, 3).dotProduct(new Vector(-1, -2, -3))));
		// TC05: multiply by the equal vector
		assertTrue(Util.isZero(14 - new Vector(1, 2, 3).dotProduct(new Vector(1, 2, 3))));
		// TC06:multiply by orthogonal vector
		assertTrue(Util.isZero(new Vector(1, 0, 0).dotProduct(new Vector(0, 1, 0))));
		// TC07:multiply vectors with the same length
		assertTrue(Util.isZero(15 - new Vector(3, 4, 0).dotProduct(new Vector(5, 0, 0))));
	}
	...
	public void testLengthSquared() {
		// ============ Equivalence Partitions Tests ==============
		// TC01:
		assertTrue(Util.isZero(14 - new Vector(1, 2, 3).lengthSquared()));
	}
	...
	public void testLength() {
		// ============ Equivalence Partitions Tests ==============
		// TC01:
		assertTrue(Util.isZero(5 - new Vector(3, 4, 0).length()));
	}
	...
	public void testNormalize() {
		...
		assertTrue(v1 == v2);
		assertEquals(new Vector(1, 0, 0), v2);
		// =============== Boundary Values Tests ==================
