...
public class ShadowTests {
	...
	/**
	 * move the triangle closer to sphere
	 */
	@Test
	...
	public void sphereTriangleInitial2() {
		scene.geometries.add( //
				new Sphere( new Point3D(0, 0, -200),60) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setnShininess(30)), //
				new Triangle(new Point3D(-70+8, -40+8, 0), new Point3D(-40+10, -70+8, 0), new Point3D(-68+8, -68+8, -4)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setnShininess(30)) //
		);
		scene.lights.add( //
	...
	public void sphereTriangleInitial3() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100+15, -100+15, 200-70), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
	...
	public void sphereTriangleInitial4() {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100+27, -100+27, 200-143), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
