...
public class RayTests {
	...
	public void testFindClosestGeoPoint() {
		...
		// ============ Equivalence Partitions Tests ==============
		// TC01: the closest point is in the middle of the list
		List<GeoPoint> list = List.of(new GeoPoint(null, new Point3D(5, 5, 5)),
				new GeoPoint(null, new Point3D(7, 7, 7)), new GeoPoint(null, new Point3D(3, 3, 3)),
				new GeoPoint(null, new Point3D(9, 9, 9)));
		assertEquals("findClosetPoint(List<Point3D>) result", new GeoPoint(null, new Point3D(3, 3, 3)),
		...
		assertEquals("findClosetPoint(List<Point3D>) result when the list is empty", null,
				ray.findClosestPoint(List.of()));
		// TC03:the closest point is the first
		list = List.of(new GeoPoint(null, new Point3D(2, 2, 2)), new GeoPoint(null, new Point3D(7, 7, 7)),
				new GeoPoint(null, new Point3D(3, 3, 3)), new GeoPoint(null, new Point3D(9, 9, 9)));
		assertEquals("findClosetPoint(List<Point3D>) result", new GeoPoint(null, new Point3D(2, 2, 2)),
				ray.findClosestGeoPoint(list));

		// TC04:the closest point is the last
		list = List.of(new GeoPoint(null, new Point3D(5, 5, 5)), new GeoPoint(null, new Point3D(7, 7, 7)),
				new GeoPoint(null, new Point3D(6, 6, 6)), new GeoPoint(null, new Point3D(3, 3, 3)));
		assertEquals("findClosetPoint(List<Point3D>) result", new GeoPoint(null, new Point3D(3, 3, 3)),
				ray.findClosestGeoPoint(list));
	}
